...
import com.bigkoo.pickerview.adapter.NumericWheel2Adapter;
...
public class Wheel2Time {
    ...
    public Wheel2Time(View view, boolean[] type, int gravity, int textSize) {
        super();
        this.view = view;
        this.type = type;
    ...
    private void setSolar(int year, final int month, int day, int h, int m, int s) {
        ...
        wv_year.setAdapter(new NumericWheel2Adapter(startYear, endYear));// 设置"年"的显示数据
...
//                sb.append((wv_year.getCurrentItem() + startYear)).append("-")
                sb.append((endYear - wv_year.getCurrentItem())).append("-")
